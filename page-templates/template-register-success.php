                ...
                <div class=" px-0 pt-4 pb-0 mt-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 mx-0">
                            <form id="msform">
                                <fieldset id="so-complete-verify">
                                    <div class="form-card register-step-completed">
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12 d-flex align-items-center verify-done">
                                                ...
                                                <div class="verify-com-text pl-3">
                                                    <h5>Verification complete</h5>
                                                    <p>Enjoy our sevice</p>
                                                </div>
                                            </div>
                                    ...
                                    <!-- <input type="button" name="previous" class="previous action-button-previous"
                                        value="" /> -->
                                    <!-- <input type="button" name="make_payment" href="/feeds"
                                        class="next so-action-button mt-3 finish-verification-btn" value="Finish" /> -->

                                    <div class="next so-action-button mt-3 finish-verification-btn">
                                        <a href="/feeds">FINISH</a>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
