            ...
            <div class="col-md-12">
                <div class="seller-search-header">
                    <div class="seller-header-top">
                        ...
                        <div class="seller-number"><span>2556 Sellers</span></div>
                    </div>
                    <div class="seller-search-form">
                        <form>
                            <input type="input" name="search" value="" placeholder="Search Seller">
                            <i class="bi bi-search"></i>
                        </form>

                        <div class="seller-search-categories">
                            <figure>
                                <img src="/wp-content/uploads/2024/05/profile-7.jpg" alt="seller-image">
                                <h5 class="text-center">Asian</h5>
                            </figure>
                            <figure>
                                <img src="/wp-content/uploads/2024/05/profile-7.jpg" alt="seller-image">
                                <h5 class="text-center">Asian</h5>
                        ...
                        <div class=" seller-filter-dropdowns-lists seller-dropdown-age">
                            ...
                            <select id="age-start" name="age-start">
                                ...
                                if (!empty($all_sellers)) {
                                    $ages = array(); // Array to store user ages
                                    //                                 foreach ($all_sellers as $user) {
