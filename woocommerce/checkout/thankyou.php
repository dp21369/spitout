...
?>
<div class="woocommerce-order so-thankyou-page so-feed-new-container m-auto">
    ...
    ?>
        ...
        <?php if ($order->has_status('failed')) : ?>
            ...
            <p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed so-order-recieved-notice">
        ...
        <?php else : ?>
            ...
            <div>
                <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details so-ty-order-review">
                    ...
                    <li class="woocommerce-order-overview__total total">
                        ...
                        <strong>
                            ...
                            //echo  dynamic_currency_for_buyer_seller_order_pages($order->get_id());  
                            ?>
                        </strong>
                    </li>
